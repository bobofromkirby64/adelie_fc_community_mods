...
heavy_maddy = {
    ...
    update = function(this)
        ...
        if this.freeze > 0 then
            ...
            if this.freeze == 0 then
                this:move(this.vx*4/5, this.vy*4/5) -- hack so we don't miss a move when we freeze
        ...
        if this.hitstun > 0 then
            ...
            if this.dash_time > 0 then
                ...
                -- dash attack
                hitbox.create(this.connectionID, hb_x, hb_y, hb_w, hb_h, 5, util.sign(this.vx)*5, (this.down_attack or dair_landed) and -2 or util.sign(this.vy) * 3 - 1, 2)
            else
                local maxrun = 2
        ...
        this:move(this.vx*4/5, this.vy*4/5)
        this:check_snowballs()
